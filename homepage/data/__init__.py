# This Python list saves dicts with information for the orange.biolab.si
# landing page feature panels
FEATURE_DESCRIPTIONS = [
    {
        'title': 'Visual Programming',
        'description': 'Interactive data exploration for rapid qualitative '
                       'analysis with clean visualizations. Graphic user '
                       'interface allows you to focus on exploratory data '
                       'analysis instead of coding, while clever defaults make'
    ...
    },
    {
        ...
        'description': 'Perform simple data analysis with clever data '
                       'visualization. Explore statistical distributions, box '
                       'plots and scatter plots, or dive deeper with decision '
                       'trees, hierarchical clustering, heatmaps, MDS and '
    ...
    },
    {
        ...
        'description': 'Orange features an extensive scripting library of '
                       'standard  supervised and unsupervised machine learning'
                       ' algorithms, such as linear and logistic regression, '
                       'classification trees, random forests, naive bayes and '
                       'k-means clustering for outlier detection, seamless '
                       'predictive model construction, evaluation, and '
    ...
    },
    {
        ...
        'description': 'Orange can be used for a broad variety of tasks. Its '
                       ...
                       'assessment and process optimization. It is frequently'
                       ' used in science for predictive analytics and '
    ...
    },
    {
        ...
        'description': 'Use various add-ons available within Orange to mine '
                       'data from external data sources, perform natural '
                       'language processing and text mining, conduct network '
                       'analysis, infer frequent itemset and do association '
                       'rules mining. Additionally, bioinformaticians and '
